...
def test_address():
    ...
    * CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.
    ...
    #print(Fore.RED + "[ETHEREUM ADDRESSES ONLY]" + Fore.WHITE)
    contract_address = input(Fore.RED + "[POLYGON ADDRESSES ONLY]" + Fore.WHITE + " TARGET CONTRACT >> ")
    ...
    try:
        ...
        print("Failed to decode JSON response from Polygonscan API")
        return
    ...
    if data_transfers['status'] == "1":
        ...
        try:
            ...
            print("Failed to decode JSON response from Polygonscan API for contract details")
            return
