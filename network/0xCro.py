...
def test_address():
    ...
    * CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.
    ...
    contract_address = input(Fore.RED + "[CRONOS ADDRESSES ONLY]" + Fore.WHITE + " TARGET CONTRACT >> ")
    ...
    try:
        ...
        print("Failed to decode JSON response from CronoScan API")
        return
    ...
    if data_transfers['status'] == "1":
        ...
        try:
            ...
            print("Failed to decode JSON response from CronoScan API for contract details")
            return
